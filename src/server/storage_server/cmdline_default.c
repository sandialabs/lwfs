/*
  ...
  /home/raoldfi/software/i386/bin/gengetopt -S --set-package=authr-server --set-version=0.1 -F cmdline_default --output-dir=../../../../../src/server/storage_server 
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --lwfs-config-file=STRING Path to the lwfs config file",
  ...
  "      --ss-trace                Enable tracing  (default=off)",
  "      --ss-tracefile=STRING     Path to the trace file  \n                                  (default=`ss-trace.sddf')",
  "      --ss-traceftype=INT       Type of tracefile (0=binary,1=ASCII)  \n                                  (default=`0')",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ss_trace_given = 0 ;
  args_info->ss_tracefile_given = 0 ;
  args_info->ss_traceftype_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ss_trace_flag = 0;
  args_info->ss_tracefile_arg = gengetopt_strdup ("ss-trace.sddf");
  args_info->ss_tracefile_orig = NULL;
  args_info->ss_traceftype_arg = 0;
  args_info->ss_traceftype_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->lwfs_config_file_help = gengetopt_args_info_help[5] ;
  args_info->ss_pid_help = gengetopt_args_info_help[6] ;
  args_info->ss_numbufs_help = gengetopt_args_info_help[7] ;
  args_info->ss_bufsize_help = gengetopt_args_info_help[8] ;
  args_info->ss_root_help = gengetopt_args_info_help[9] ;
  args_info->ss_iolib_help = gengetopt_args_info_help[10] ;
  args_info->ss_xfer_only_help = gengetopt_args_info_help[11] ;
  args_info->ss_db_path_help = gengetopt_args_info_help[12] ;
  args_info->ss_db_clear_help = gengetopt_args_info_help[13] ;
  args_info->ss_db_recover_help = gengetopt_args_info_help[14] ;
  args_info->ss_trace_help = gengetopt_args_info_help[15] ;
  args_info->ss_tracefile_help = gengetopt_args_info_help[16] ;
  args_info->ss_traceftype_help = gengetopt_args_info_help[17] ;
  args_info->verbose_help = gengetopt_args_info_help[18] ;
  args_info->logfile_help = gengetopt_args_info_help[19] ;
  args_info->tp_init_thread_count_help = gengetopt_args_info_help[20] ;
  args_info->tp_min_thread_count_help = gengetopt_args_info_help[21] ;
  args_info->tp_max_thread_count_help = gengetopt_args_info_help[22] ;
  args_info->tp_low_watermark_help = gengetopt_args_info_help[23] ;
  args_info->tp_high_watermark_help = gengetopt_args_info_help[24] ;
  args_info->authr_pid_help = gengetopt_args_info_help[25] ;
  args_info->authr_nid_help = gengetopt_args_info_help[26] ;
  args_info->authr_cache_caps_help = gengetopt_args_info_help[27] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->lwfs_config_file_arg)
    {
      free (args_info->lwfs_config_file_arg); /* free previous argument */
      args_info->lwfs_config_file_arg = 0;
    }
  if (args_info->lwfs_config_file_orig)
    {
      free (args_info->lwfs_config_file_orig); /* free previous argument */
      args_info->lwfs_config_file_orig = 0;
    }
  ...
  if (args_info->ss_tracefile_arg)
    {
      free (args_info->ss_tracefile_arg); /* free previous argument */
      args_info->ss_tracefile_arg = 0;
    }
  if (args_info->ss_tracefile_orig)
    {
      free (args_info->ss_tracefile_orig); /* free previous argument */
      args_info->ss_tracefile_orig = 0;
    }
  if (args_info->ss_traceftype_orig)
    {
      free (args_info->ss_traceftype_orig); /* free previous argument */
      args_info->ss_traceftype_orig = 0;
    }
...
cmdline_parser_file_save(const char *filename, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->lwfs_config_file_given) {
    if (args_info->lwfs_config_file_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "lwfs-config-file", args_info->lwfs_config_file_orig);
    } else {
      fprintf(outfile, "%s\n", "lwfs-config-file");
    }
  }
  ...
  if (args_info->ss_trace_given) {
    fprintf(outfile, "%s\n", "ss-trace");
  }
  if (args_info->ss_tracefile_given) {
    if (args_info->ss_tracefile_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "ss-tracefile", args_info->ss_tracefile_orig);
    } else {
      fprintf(outfile, "%s\n", "ss-tracefile");
    }
  }
  if (args_info->ss_traceftype_given) {
    if (args_info->ss_traceftype_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "ss-traceftype", args_info->ss_traceftype_orig);
    } else {
      fprintf(outfile, "%s\n", "ss-traceftype");
    }
  }
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "ss-trace",	0, NULL, 0 },
        { "ss-tracefile",	1, NULL, 0 },
        { "ss-traceftype",	1, NULL, 0 },
        { "verbose",	1, NULL, 0 },
        { "logfile",	1, NULL, 0 },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Path to the lwfs config file.  */
          else if (strcmp (long_options[option_index].name, "lwfs-config-file") == 0)
          {
            if (local_args_info.lwfs_config_file_given)
              {
                fprintf (stderr, "%s: `--lwfs-config-file' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->lwfs_config_file_given && ! override)
              continue;
            local_args_info.lwfs_config_file_given = 1;
            args_info->lwfs_config_file_given = 1;
            if (args_info->lwfs_config_file_arg)
              free (args_info->lwfs_config_file_arg); /* free previous string */
            args_info->lwfs_config_file_arg = gengetopt_strdup (optarg);
            if (args_info->lwfs_config_file_orig)
              free (args_info->lwfs_config_file_orig); /* free previous string */
            args_info->lwfs_config_file_orig = gengetopt_strdup (optarg);
          }
          ...
          /* Enable tracing.  */
          else if (strcmp (long_options[option_index].name, "ss-trace") == 0)
          {
            if (local_args_info.ss_trace_given)
              {
                fprintf (stderr, "%s: `--ss-trace' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->ss_trace_given && ! override)
              continue;
            local_args_info.ss_trace_given = 1;
            args_info->ss_trace_given = 1;
            args_info->ss_trace_flag = !(args_info->ss_trace_flag);
          }
          /* Path to the trace file.  */
          else if (strcmp (long_options[option_index].name, "ss-tracefile") == 0)
          {
            if (local_args_info.ss_tracefile_given)
              {
                fprintf (stderr, "%s: `--ss-tracefile' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->ss_tracefile_given && ! override)
              continue;
            local_args_info.ss_tracefile_given = 1;
            args_info->ss_tracefile_given = 1;
            if (args_info->ss_tracefile_arg)
              free (args_info->ss_tracefile_arg); /* free previous string */
            args_info->ss_tracefile_arg = gengetopt_strdup (optarg);
            if (args_info->ss_tracefile_orig)
              free (args_info->ss_tracefile_orig); /* free previous string */
            args_info->ss_tracefile_orig = gengetopt_strdup (optarg);
          }
          /* Type of tracefile (0=binary,1=ASCII).  */
          else if (strcmp (long_options[option_index].name, "ss-traceftype") == 0)
          {
            if (local_args_info.ss_traceftype_given)
              {
                fprintf (stderr, "%s: `--ss-traceftype' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->ss_traceftype_given && ! override)
              continue;
            local_args_info.ss_traceftype_given = 1;
            args_info->ss_traceftype_given = 1;
            args_info->ss_traceftype_arg = strtol (optarg, &stop_char, 0);
            if (!(stop_char && *stop_char == '\0')) {
              fprintf(stderr, "%s: invalid numeric value: %s\n", argv[0], optarg);
              goto failure;
            }
            if (args_info->ss_traceftype_orig)
              free (args_info->ss_traceftype_orig); /* free previous string */
            args_info->ss_traceftype_orig = gengetopt_strdup (optarg);
          }
