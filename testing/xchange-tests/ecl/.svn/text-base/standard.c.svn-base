...
#ifdef HAVE_CERCS_ENV_H
IOField chr_time_list[] = {
    {"d1", "double", sizeof(double), IOOffset(chr_time*, d1)}, 
    {"d2", "double", sizeof(double), IOOffset(chr_time*, d2)}, 
    {"d3", "double", sizeof(double), IOOffset(chr_time*, d3)}, 
    {NULL, NULL, 0, 0}};
#endif

extern void
ecl_add_standard_elements(ecl_parse_context context)
{
#ifdef HAVE_ATL_H
    sm_ref attr_node = ecl_new_reference_type_decl();
    attr_node->node.reference_type_decl.name = strdup("attr_list");
    ecl_add_decl_to_parse_context("attr_list", attr_node, context);
    ecl_add_decl_to_scope("attr_list", attr_node, context);
    ecl_add_defined_type("attr_list", context);
#endif
#ifdef HAVE_CERCS_ENV_H
    ecl_add_struct_type("chr_time", chr_time_list, context);
#endif
    ecl_add_defined_type("ecl_type_spec", context);
    ecl_add_defined_type("ecl_exec_context", context);
    ecl_semanticize_added_decls(context);
    ...
    ecl_swap_decls_to_standard(context);
#endif
}
