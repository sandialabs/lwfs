/*
  ...
  /home/raoldfi/software/i386/bin/gengetopt -S --set-package=lwfs --set-version=0.1 --output-dir=../../../../../src/server/naming_server -F cmdline_default 
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --naming-pid=INT          The process ID to use for the naming server  \n                                  (default=`126')",
  "      --naming-db-path=STRING   Path to the naming database  \n                                  (default=`naming.db')",
  "      --naming-db-clear         Clear the naming database before use  \n                                  (default=off)",
  "      --naming-db-recover       Recover the naming database after a crash  \n                                  (default=off)",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->naming_pid_given = 0 ;
  args_info->naming_db_path_given = 0 ;
  args_info->naming_db_clear_given = 0 ;
  args_info->naming_db_recover_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->naming_pid_arg = 126;
  args_info->naming_pid_orig = NULL;
  args_info->naming_db_path_arg = gengetopt_strdup ("naming.db");
  args_info->naming_db_path_orig = NULL;
  args_info->naming_db_clear_flag = 0;
  args_info->naming_db_recover_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->naming_pid_help = gengetopt_args_info_help[5] ;
  args_info->naming_db_path_help = gengetopt_args_info_help[6] ;
  args_info->naming_db_clear_help = gengetopt_args_info_help[7] ;
  args_info->naming_db_recover_help = gengetopt_args_info_help[8] ;
  args_info->verbose_help = gengetopt_args_info_help[9] ;
  args_info->logfile_help = gengetopt_args_info_help[10] ;
  args_info->tp_init_thread_count_help = gengetopt_args_info_help[11] ;
  args_info->tp_min_thread_count_help = gengetopt_args_info_help[12] ;
  args_info->tp_max_thread_count_help = gengetopt_args_info_help[13] ;
  args_info->tp_low_watermark_help = gengetopt_args_info_help[14] ;
  args_info->tp_high_watermark_help = gengetopt_args_info_help[15] ;
  args_info->authr_pid_help = gengetopt_args_info_help[16] ;
  args_info->authr_nid_help = gengetopt_args_info_help[17] ;
  args_info->authr_cache_caps_help = gengetopt_args_info_help[18] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->naming_pid_orig)
    {
      free (args_info->naming_pid_orig); /* free previous argument */
      args_info->naming_pid_orig = 0;
    }
  if (args_info->naming_db_path_arg)
    {
      free (args_info->naming_db_path_arg); /* free previous argument */
      args_info->naming_db_path_arg = 0;
    }
  if (args_info->naming_db_path_orig)
    {
      free (args_info->naming_db_path_orig); /* free previous argument */
      args_info->naming_db_path_orig = 0;
    }
...
cmdline_parser_file_save(const char *filename, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->naming_pid_given) {
    if (args_info->naming_pid_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "naming-pid", args_info->naming_pid_orig);
    } else {
      fprintf(outfile, "%s\n", "naming-pid");
    }
  }
  if (args_info->naming_db_path_given) {
    if (args_info->naming_db_path_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "naming-db-path", args_info->naming_db_path_orig);
    } else {
      fprintf(outfile, "%s\n", "naming-db-path");
    }
  }
  if (args_info->naming_db_clear_given) {
    fprintf(outfile, "%s\n", "naming-db-clear");
  }
  if (args_info->naming_db_recover_given) {
    fprintf(outfile, "%s\n", "naming-db-recover");
  }
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "daemon",	0, NULL, 0 },
        { "naming-pid",	1, NULL, 0 },
        { "naming-db-path",	1, NULL, 0 },
        { "naming-db-clear",	0, NULL, 0 },
        { "naming-db-recover",	0, NULL, 0 },
        { "verbose",	1, NULL, 0 },
        { "logfile",	1, NULL, 0 },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* The process ID to use for the naming server.  */
          else if (strcmp (long_options[option_index].name, "naming-pid") == 0)
          {
            if (local_args_info.naming_pid_given)
              {
                fprintf (stderr, "%s: `--naming-pid' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->naming_pid_given && ! override)
              continue;
            local_args_info.naming_pid_given = 1;
            args_info->naming_pid_given = 1;
            args_info->naming_pid_arg = strtol (optarg, &stop_char, 0);
            if (!(stop_char && *stop_char == '\0')) {
              fprintf(stderr, "%s: invalid numeric value: %s\n", argv[0], optarg);
              goto failure;
            }
            if (args_info->naming_pid_orig)
              free (args_info->naming_pid_orig); /* free previous string */
            args_info->naming_pid_orig = gengetopt_strdup (optarg);
          }
          /* Path to the naming database.  */
          else if (strcmp (long_options[option_index].name, "naming-db-path") == 0)
          {
            if (local_args_info.naming_db_path_given)
              {
                fprintf (stderr, "%s: `--naming-db-path' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->naming_db_path_given && ! override)
              continue;
            local_args_info.naming_db_path_given = 1;
            args_info->naming_db_path_given = 1;
            if (args_info->naming_db_path_arg)
              free (args_info->naming_db_path_arg); /* free previous string */
            args_info->naming_db_path_arg = gengetopt_strdup (optarg);
            if (args_info->naming_db_path_orig)
              free (args_info->naming_db_path_orig); /* free previous string */
            args_info->naming_db_path_orig = gengetopt_strdup (optarg);
          }
          /* Clear the naming database before use.  */
          else if (strcmp (long_options[option_index].name, "naming-db-clear") == 0)
          {
            if (local_args_info.naming_db_clear_given)
              {
                fprintf (stderr, "%s: `--naming-db-clear' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->naming_db_clear_given && ! override)
              continue;
            local_args_info.naming_db_clear_given = 1;
            args_info->naming_db_clear_given = 1;
            args_info->naming_db_clear_flag = !(args_info->naming_db_clear_flag);
          }
          /* Recover the naming database after a crash.  */
          else if (strcmp (long_options[option_index].name, "naming-db-recover") == 0)
          {
            if (local_args_info.naming_db_recover_given)
              {
                fprintf (stderr, "%s: `--naming-db-recover' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->naming_db_recover_given && ! override)
              continue;
            local_args_info.naming_db_recover_given = 1;
            args_info->naming_db_recover_given = 1;
            args_info->naming_db_recover_flag = !(args_info->naming_db_recover_flag);
          }
