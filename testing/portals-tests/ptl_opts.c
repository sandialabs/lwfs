/*
  ...
  /home/raoldfi/software/i386/bin/gengetopt -F ../../../../testing/portals-tests/ptl_opts -S --set-package=lwfs-tests --set-version=0.1 
...
#include "../../../../testing/portals-tests/ptl_opts.h"
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --count=INT            The number of messages to send/recive  \n                               (default=`1')",
  "      --server               A flag that identifies this process as a server  \n                               (default=off)",
  "      --server-pid=LONGLONG  The process ID of the server  (default=`98')",
  "      --server-nid=LONGLONG  The node ID of the server  (default=`0')",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->count_help = gengetopt_args_info_help[2] ;
  args_info->server_help = gengetopt_args_info_help[3] ;
  args_info->server_pid_help = gengetopt_args_info_help[4] ;
  args_info->server_nid_help = gengetopt_args_info_help[5] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          /* The number of messages to send/recive.  */
          ...
          /* A flag that identifies this process as a server.  */
